...
list_file = [file for file in os.listdir('data') if file[-4:]=='.txt' and file[:5]=='level']
if list_file:
    print('Имена файлов с доступными для загрузки уровнями:') # для отображения файлы с уровнями игры должны именоваться level*.txt
    for f in list_file:
        print(f)
